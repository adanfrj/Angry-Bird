...
public class SlingShooter : MonoBehaviour
{
    ...
    void OnMouseUp()
    {
        ...
        //fungsi untuk burung bisa terlempar
        _bird.Shoot(velocity, distance, throwSpeed);

        
        //fungsi untuk Kembalikan ketapel ke posisi awal
        gameObject.transform.position = startPos;

        //fungsi keadaan trajectory
    ...
    void OnMouseDrag()
    {
        ...
        //menggambarkan ulang trajectory dari burung yang akan dilempar
    ...
    //method trajectory berfungsi untuk memprediksikan posisi burung dengan rumus
    ...
    void DisplayTrajectory(float distance)
    {
        ...
        // Posisi awal trajectoy adalah posisi mouse dari player saat ini
        segments[0] = transform.position;

        // Velocity awal
        Vector2 segVelocity = velocity * throwSpeed * distance;

        //total point/titik digambarkan dalam trajectory
